...
#define STRING_CONFIG_H_AUTHOR "(NetrunnerAT, Anycubic i3 Mega)" // Who made the changes.
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  //12V 100W Anycubic Mega Ultrabase
  #define DEFAULT_bedKp 248.85
  #define DEFAULT_bedKi 49.00
  #define DEFAULT_bedKd 315.97
